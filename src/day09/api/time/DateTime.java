...
//        Calendar calendar = Calendar.getInstance();// 추상 클래스라서 객체로 만들어줘서 사용해
...
//        원하는 정보 추출
        ...
        int monthValue = nowDateTime.getMonthValue(); // 월
        System.out.println("monthValue = " + monthValue);
        int dayOfMonth = nowDateTime.getDayOfMonth(); // 일
...
//        사이 날짜 구하기
        ...
        System.out.println("between = " + between/365 + " 년");
