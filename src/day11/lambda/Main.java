...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Apple> filteredApples = FilterApple.filterApplesByColor(appleBasket, RED);
        for (Apple filteredColorApple : filteredApples) {
...
//        100g 이하인 사과를 필터링
        List<Apple> apples1 = FilterApple.filterApples(appleBasket, new LightApplePredicate());
        for (Apple apple : apples1) {
            System.out.println(apple);
        }

//        빨간 또는 노랑 사과만 필터링
        List<Apple> apples2 = FilterApple.filterApples(appleBasket, new ApplePredicate() {
            @Override
...
//        녹색이면서 100g 이상인 사과들만 필터링
        List<Apple> apples3 = FilterApple.filterApples(appleBasket,
