...
import static day05.book.RentStatus.RENT_SUCCESS;
import static day05.book.RentStatus.RENT_SUCCESS_WITH_COUPON;
import static day05.book.RentStatus.RENT_CANCEL;
    ...
    private static void selectMenu() {
        ...
        switch (menuNum) {
            ...
            case "4":
                ...
                } else if (rentStatus == RENT_CANCEL) {
                    System.out.println("# 도서 대여가 취소 되었습니다 ");
                } else {
